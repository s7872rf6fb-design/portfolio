...
const worksData = [
  {
    ...
    images: [
      { src: "images/todopic.JPG", title: "" },
      { src: "images/todo1f.jpg", title: "1F Plan" },
      { src: "images/todo2f.jpg", title: "2F Plan" },
      { src: "images/todosec1.jpg", title: "Longitudinal Section" },
      { src: "images/todosec2.jpg", title: "Cross Section" },
      { src: "images/todosec3.jpg", title: "Section Detail" },
      { src: "images/todoiso.jpg", title: "Structural Isometric View" },
    ]
  },
  {
    key: "year2",
    ...
    images: [
      { src: "images/daipic.jpg", title: "" },
      { src: "images/dai1f.jpg", title: "1F Plan" },
      { src: "images/dai2f.jpg", title: "2F Plan" },
      { src: "images/dai3f.jpg", title: "3F Plan" },
      { src: "images/dai4f.jpg", title: "4F Plan" },
      { src: "images/dai5f.jpg", title: "5F Plan" },
      { src: "images/daisec.jpg", title: "Longitudinal Section" },
      { src: "images/daiiso.jpg", title: "Structural Isometric View" },
    ]
  },
  {
    key: "year3-1",
    ...
    images: [
      { src: "images/micropic1.jpg", title: "" },
      { src: "images/micropic2.jpg", title: "" },
      { src: "images/micro1f.jpg", title: "1F Plan" },
      { src: "images/micro2f.jpg", title: "2F Plan" },
      { src: "images/microele.jpg", title: "Long Elevation" },
      { src: "images/microsec1.jpg", title: "Longitudinal Section" },
      { src: "images/microsec2.jpg", title: "Cross section" },

    ]
  },
  {
    key: "year3-2",
    year: { jp: "3年 前期 第二課題", en: "3rd Year, 1st Semester, Project 2" },
    title: { 
      jp: "大学院キャンパス 『脱完成キャンパス』", 
      en: "Graduate School Campus 'The Unfinished Campus'" },
    desc: { jp: "本計画は、近代の完成された建築の批評として、変化し続けること自体を強固な機能とした未完成のキャンパスの提案である。半永久的なメガフレームの隙間に、学生自体が即興で脱着できる単管パイプの可変床を挿入し、日々空間が書き換えられる原寸大の実験場を提案する。１階の製図室を街へ開いて学びのプロセスを露出させ、上層では教員室の目前に学生のモックアップを突き刺すことで、従来の学校建築が持つ固定的な秩序を解体する。", 
            en: "As a critique of modern, static architecture, this project proposes an \"unfinished\" campus where continuous transformation itself serves as a core function. Within the voids of a semi-permanent mega-frame, adaptable floors made of scaffolding pipes are inserted, allowing students to improvise, assemble, and detach them at will. This creates a full-scale experimental ground where spatial configurations are rewritten daily. By opening the ground-floor drafting room to the street to expose the learning process, and directly thrusting student mock-ups in front of faculty offices on the upper levels, this design dismantles the rigid order inherent in conventional school architecture." },

    award: {
      jp: "能作淳平賞",
      en: "The Jyunpei Nousaku Award"
    },

    images: [
      { src: "images/campas1.jpg", title: "" },
